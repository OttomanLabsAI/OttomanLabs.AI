 ...
 *
 * Order in the nav: Home · Contact · [Cloud] · Dark — the cloud button is
 * injected by assets/ol-cloud.js into #olCloudMount, left of the toggle.
 *
 * The toggle exposes window.__setTheme(mode) and window.__theme, persists to
 * localStorage 'ol-theme', and dispatches 'themechange' + 'resize' so every
